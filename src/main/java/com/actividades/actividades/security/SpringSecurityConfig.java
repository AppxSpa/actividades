package com.actividades.actividades.security;
...
import com.actividades.actividades.security.filter.JwtValidationFilter;
import com.actividades.actividades.utils.JwtUtils;
    ...
    SecurityFilterChain filterChain(HttpSecurity http, JwtUtils jwtUtils) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authz -> authz
                 .requestMatchers(HttpMethod.GET,"/api/actividades/documents/**").permitAll()
